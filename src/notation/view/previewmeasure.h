...
public:
    ...
    bool isBeyondScore(const NoteInputState& state, const muse::PointF& mousePos) const;

    muse::RectF previewRect(const NoteInputState& state, const muse::PointF& mousePos) const;
